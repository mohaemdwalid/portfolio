...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative overflow-hidden">
      ...
      <img src="/3D-portfolio/public/images/bg.png" alt="" />
        ...
        <header className="flex flex-col justify-center md:full w-screen md:px-20 px-5">
          <div className="flex flex-col gap-7">
            ...
            <p className="text-white-50 md:text-xl relative z-10">
              I am a passionate and experienced web developer with a strong<br />
              background in MERN Full Stack Developer crafting fast, user-friendly
            </p>
            <Button
